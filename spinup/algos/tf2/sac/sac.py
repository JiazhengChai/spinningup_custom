...
import gym
import time
from spinup.algos.tf2.sac import core
from spinup.algos.tf2.sac.core import get_vars
...
def sac(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
        ...
        max_ep_len=1000, logger_kwargs=dict(), save_freq=1, num_test_episodes=3):
    """
    ...
    def test_agent(n=num_test_episodes):
