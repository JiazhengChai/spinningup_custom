...
import gym
import time
from spinup.algos.tf2.td3 import core
from spinup.algos.tf2.td3.core import get_vars
...
def td3(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
    ...
    with tf.compat.v1.variable_scope('target', reuse=True):
        ...
        epsilon = tf.compat.v1.random_normal(tf.shape(pi_targ), stddev=target_noise)
